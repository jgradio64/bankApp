...
namespace BankTests
{
    ...
    public class UnitTest1
    {
        ...
        {
            Bank NewBank = new("000001", "Some Bank Name");
        ...
        {
            Bank NewBank = new("000001", "Some Bank Name");
            IndividualOwner NewOwner = new("1", "Itch", "Skill", "iskill0@irs.gov", "718-632-9460", "1 Fairview Trail", "Brooklyn", "New York", "11225");
            IndividualInvevtmentAccount NewAccount = new(NewOwner, "1", 400);
        ...
        {
            Bank NewBank = new("000001", "Some Bank Name");
            CorporateOwner NewOwner = new("1", "I Skill Up Academy", "iskill0@irs.gov", "718-632-9460", "1 Fairview Trail", "Brooklyn", "New York", "11225");
            CorporateInvestmentAccount NewAccount = new(NewOwner, "1", 4000);
            NewBank.AddAccount(NewAccount);
        ...
        public void WithdrawShouldFail()
        {
            Bank NewBank = new("000001", "Some Bank Name");
            IndividualOwner NewOwner = new("1", "Itch", "Skill", "iskill0@irs.gov", "718-632-9460", "1 Fairview Trail", "Brooklyn", "New York", "11225");
            IndividualInvevtmentAccount NewAccount = new(NewOwner, "1", 800);
            NewBank.AddAccount(NewAccount);
        ...
        {
            Bank NewBank = new("000001", "Some Bank Name");
            IndividualOwner IOwner1 = new("1", "Itch", "Skill", "iskill0@irs.gov", "718-632-9460", "1 Fairview Trail", "Brooklyn", "New York", "11225");
            IndividualOwner IOwner2 = new("2", "Sigvard", "Doxey", "sdoxey1@unicef.org", "315-152-3050", "284 Redwing Circle", "Syracuse", "New York", "13205");
            IndividualInvevtmentAccount InvAccount1 = new(IOwner1, "1", 400);
            IndividualInvevtmentAccount InvAccount2 = new(IOwner2, "2", 0);
        ...
        public void TransferFundsShouldWork()
        {
            ...
            IndividualOwner IOwner1 = new("1", "Itch", "Skill", "iskill0@irs.gov", "718-632-9460", "1 Fairview Trail", "Brooklyn", "New York", "11225");
            IndividualOwner IOwner2 = new("2", "Sigvard", "Doxey", "sdoxey1@unicef.org", "315-152-3050", "284 Redwing Circle", "Syracuse", "New York", "13205");
            IndividualInvevtmentAccount InvAccount1 = new(IOwner1, "1", 600);
            IndividualInvevtmentAccount InvAccount2 = new(IOwner2, "2", 0);
            NewBank.AddAccount(InvAccount2);
            NewBank.AddAccount(InvAccount1);
            NewBank.TransferFundsBetweenAccounts("1", "2", 500);
